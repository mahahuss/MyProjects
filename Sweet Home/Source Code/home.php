...
?>
	...
	<?php
		//get information from database to display all categories
	$sqel="SELECT * FROM category";
                ...
                <div class="portfolio-item">
                        ...
                        <div class="hover-effect">
                            <div class="hover-content">
								...
								<?php $id=$rows['id'];
								$name=$rows['name'];
								print "<a href='category.php?id=$id'>
                        ...
                        <div class="image">
                            <?php // display image 
 echo '<img src="data:images/jpg;base64,'.base64_encode($rows['category_image'] ).'" height="200" width="200" class="img-thumnail" />';
